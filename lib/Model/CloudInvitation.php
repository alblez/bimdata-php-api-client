...
class CloudInvitation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 256)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CloudInvitation., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CloudInvitation., must be bigger than or equal to 1.');
        }
    ...
    public function setRedirectUri($redirect_uri)
    {
        if ((mb_strlen($redirect_uri) > 512)) {
            throw new \InvalidArgumentException('invalid length for $redirect_uri when calling CloudInvitation., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($redirect_uri) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirect_uri when calling CloudInvitation., must be bigger than or equal to 1.');
        }
