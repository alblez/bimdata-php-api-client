 ...
 */
class ProjectAccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setToken($token)
    {
        ...
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling ProjectAccessToken., must be bigger than or equal to 1.');
        }
