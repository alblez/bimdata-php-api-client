...
/**
 * IfcCheckerResults Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IfcCheckerResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IfcChecker_results';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['checker'] === null) {
            $invalidProperties[] = "'checker' can't be null";
        }
