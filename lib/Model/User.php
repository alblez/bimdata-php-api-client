...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets project_role
     *
     * @param int|null $project_role project_role
     *
     * @return self
     */
    ...
    public function setProvider($provider)
    {
        ...
        if (!is_null($provider) && (mb_strlen($provider) < 1)) {
            throw new \InvalidArgumentException('invalid length for $provider when calling User., must be bigger than or equal to 1.');
        }
    ...
    public function setSub($sub)
    {
        ...
        if (!is_null($sub) && (mb_strlen($sub) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sub when calling User., must be bigger than or equal to 1.');
        }
