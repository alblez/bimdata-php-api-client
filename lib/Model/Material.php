...
class Material implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Material., must be bigger than or equal to 1.');
        }
    ...
    public function setCategory($category)
    {
        ...
        if (!is_null($category) && (mb_strlen($category) < 1)) {
            throw new \InvalidArgumentException('invalid length for $category when calling Material., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Material., must be bigger than or equal to 1.');
        }
