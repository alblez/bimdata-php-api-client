...
class Label implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Label., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Label., must be bigger than or equal to 1.');
        }
