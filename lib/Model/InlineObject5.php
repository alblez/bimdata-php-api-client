...
class InlineObject5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject5., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject5., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && (mb_strlen($color) > 255)) {
            throw new \InvalidArgumentException('invalid length for $color when calling InlineObject5., must be smaller than or equal to 255.');
        }
